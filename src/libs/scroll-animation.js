...
export default class ScrollAnimation extends Component {
  ...
  animate(animation, callback) {
    this.delayedAnimationTimeout = setTimeout(() => {
      this.animating = true;
      this.setState({
        classes: `animate__animated ${animation}`,
        style: {
          animationDuration: `${this.props.duration}s`
        }
      });
  ...
  animateIn(callback) {
    this.animate(this.props.animateIn.startsWith("animate__") ? this.props.animateIn : `animate__${this.props.animateIn}`, () => {
  ...
  animateOut(callback) {
    this.animate(this.props.animateOut.startsWith("animate__") ? this.props.animateOut : `animate__${this.props.animateOut}`, () => {
      this.setState({
        classes: "animate__animated",
        style: {
          animationDuration: `${this.props.duration}s`,
